...
const actualizarEstado = ({id, estado}) => {
    ClienteService.cambiarEstado(id, {estado: !estado})
        .then(() => {
            const i = clientes.value.findIndex(cliente => cliente.id === id) //encontramos la posicion de un arraglo
...
const eliminarCliente = (id) => {
    ClienteService.eliminarCliente(id)
        .then(() => {
            ...
            //reasignamos un nuevo objeto con los filtrod (todos ecepto la psoicin del id)
        })
        .catch(error => console.log(error))
}
...
<template>
    <div>
        <div class="flex justify-end">
            <RouterLinkVue to="agregar-cliente">
                ...
                <div class="min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <Cliente v-for="cliente in clientes" :key="cliente.id" v-bind:cliente="cliente" @actualizar-estado="actualizarEstado" @eliminar-cliente="eliminarCliente"> <!-- v-bind pasamos vai props el objeto de cliente -->
        ...
        <p v-else class="text-center mt-10 text-2xl font-bold text-gray-400">No hay clientes</p>
